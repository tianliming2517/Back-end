<template>
    <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            ...
            <el-form-item>
                <el-input v-model="dataForm.release" :disabled="true"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        >
            ...
            <el-table-column
                ...
                label="资产类型"
            ></el-table-column>
            <el-table-column prop="dUnit" header-align="center" align="center" label="D资产单价(兑USDT)"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        assetType: function(row, column, value) {
            if (value == "1") return "A资产";
            if (value == "2") return "可用D资产";
            if (value == "3") return "基金D资产";
            if (value == "4") return "S资产";
            if (value == "5") return "可用S资产";
            if (value == "6") return "基金S资产";
            else if (value == "7") return "DS资产";
        }
    }
};
</script>
